...
public class HelmChartVersionFetcher implements VersionFetcher {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      logger.info(
          "Fetching versions again for artifact source (should hit cache): {}",
          testArtifact.getSource());
  ...
  private static void testParse(String versionStr) {
    ...
    logger.info(
        "Parsed '{}': {}",
        versionStr,
        parsedVer.map(Version::toString).orElse("null (failed to parse)"));
  }
